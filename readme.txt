...
1. Upload the `responsive-redirect` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Navigate to **Settings > Responsive Redirect** to configure redirection rules.
...
Yes, but make sure your caching settings allow dynamic redirects based on user agents.

= Can I use wildcards for URL patterns? =
Currently, wildcard support is not available, but future updates may include it.
...
= 1.0.0 =
* Initial release.
* Added support for mobile, tablet, and desktop redirection.
